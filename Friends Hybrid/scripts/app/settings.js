...
var appSettings = {
    ...
    everlive: {
        apiKey: '8UMhIIBcAS824BAE', // Put your Backend Services API key here
        scheme: 'http',
        url: ''
    },

    eqatec: {
        productKey: 'df19656c4f7941c585281a1f116884da',  // Put your EQATEC product key here
        version: '1.0.0.0' // Put your application version here
    },
    
    feedback: {
        apiKey: 'eea9c4a0-63b2-11e5-bfc4-ab8ff6583a35',  // Put your AppFeedback API key here
        options: {
            enableShake: true,
